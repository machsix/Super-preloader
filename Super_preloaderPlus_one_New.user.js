...
(function() {
  ...
  const sep_icons = {
    top:
      "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABYAAAAWCAYAAADEtGw7AAAAfElEQVQ4y+3TSwrAIAwE0GTqqjecE3pMu6ngotYkrQWh2RgJPD8kIl8FSW3yVPckQTJ1atu57rXeIuWNi+WcVUQEs16uxu8pV7d6BPe+aIRrBLXgsKAt0OZ3B8ODenB4USuOCGrBEUVHOLxtFGm9YT97xn7aSP/wwvB6cQDPiEmgnMEl3wAAAABJRU5ErkJggg==",
    bottom:
      "data:image/png;base64,",
    pre:
      "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABYAAAAWAgMAAAC52oSoAAAADFBMVEUAAABZWVlZWVlZWVmlGCrtAAAAA3RSTlMAAAGNcfRIAAAAW0lEQVQIHQXBsREBYRQGwDU86TcCoxwEYpIX/6Vca4og1oLksjNnF8D1tj9QPbqpnt5N9To3tusC+UxwHuOJ3/30ZTunFvLKZiKPGNQljpQodgIECBAgQIAC4A/7kRNOrZzi1QAAAABJRU5ErkJggg==",
    next:
      "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABYAAAAWAgMAAAC52oSoAAAACVBMVEUAAABZWVlZWVkxR0cfAAAAAnRSTlMAAHaTzTgAAABbSURBVAjXY2CAAVYIxUWIYoFQrEAKqIXVgYtBFCgTwMUQBaSmcDFmMTAwLeViXQFUs9JLbAGQ0oqKagDpnpUF0si0CiTFGrpqaSiIypoKpqJCgRSDoyurIMw9AMVaDvx8TrYVAAAAAElFTkSuQmCC",
    next_gray:
      "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABYAAAAWAgMAAAC52oSoAAAADFBMVEUAAABZWVlZWVmkpKR6Gts/AAAAA3RSTlMAAAGNcfRIAAAAW0lEQVQIHQXBsREBYRQGwDU86TcCoxwEYpIX/6Vca4og1oLksjNnF8D1tj9QPbqpnt5N9To3tusC+UxwHuOJ3/30ZTunFvLKZiKPGNQljpQodgIECBAgQIAC4A/7kRNOrZzi1QAAAABJRU5ErkJggg==",
    pre_gray:
      "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABYAAAAWAgMAAAC52oSoAAAACVBMVEUAAABZWVmkpKTuRbbNAAAAAnRSTlMAAHaTzTgAAABbSURBVAjXY2CAAVYIxUWIYoFQrEAKqIXVgYtBFCgTwMUQBaSmcDFmMTAwLeViXQFUs9JLbAGQ0oqKagDpnpUF0si0CiTFGrpqaSiIypoKpqJCgRSDoyurIMw9AMVaDvx8TrYVAAAAAElFTkSuQmCC"
  };
      ...
      function autopager(SSS, floatWO) {
        ...
        function createSep(lastUrl, currentUrl, nextUrl) {
          ...
          if (SSS.a_separator) {
            ...
            var pageStr = "";
            if (i8n() === "zh_CN") {
              pageStr = '第 <span style="color:#595959!important;">' + curNumber + "</span> 页" + (SSS.a_separatorReal ? getRalativePageStr(lastUrl, currentUrl, nextUrl) : "");
            } else {
              pageStr = 'Page <span style="color:#595959!important;">' + curNumber + "</span>" + (SSS.a_separatorReal ? getRalativePageStr(lastUrl, currentUrl, nextUrl) : "");
            }
            div.appendChild(
              $C(
                "a",
      ...
      if (realPageSiteMatch) {
        ...
        if (i8n() === "zh_CN") {
          if (ralativePageNumarray[1] - ralativePageNumarray[0] > 1) {
            // 一般是搜索引擎的第xx - xx项……
            ralativePageStr = ' [ 实际：第 <span style="color:#595959">' + ralativePageNumarray[0] + " - " + ralativePageNumarray[1] + "</span> 项 ]";
          } else if (ralativePageNumarray[1] - ralativePageNumarray[0] === 1) {
            // 一般的翻页数，差值应该是1
            ralativePageStr = ' [ 实际：第 <span style="color:#595959">' + ralativePageNumarray[0] + "</span> 页 ]";
          } else if ((ralativePageNumarray[0] === 0 && ralativePageNumarray[1]) === 0) {
            // 找不到的话……
            ralativePageStr = ' [ <span style="color:#595959">实际网页结束</span> ]';
          }
        } else {
          if (ralativePageNumarray[1] - ralativePageNumarray[0] > 1) {
            // 一般是搜索引擎的第xx - xx项……
            ralativePageStr = ' [ Actual elements/pages: <span style="color:#595959">' + ralativePageNumarray[0] + " - " + ralativePageNumarray[1] + "</span> ]";
          } else if (ralativePageNumarray[1] - ralativePageNumarray[0] === 1) {
            // 一般的翻页数，差值应该是1
            ralativePageStr = ' [ Actual elements/pages: <span style="color:#595959">' + ralativePageNumarray[0] + "</span> ]";
          } else if ((ralativePageNumarray[0] === 0 && ralativePageNumarray[1]) === 0) {
            // 找不到的话……
            ralativePageStr = ' [ <span style="color:#595959">Actual elements ends</span> ]';
          }
        }
      } else {
        ralativePageStr = "";
