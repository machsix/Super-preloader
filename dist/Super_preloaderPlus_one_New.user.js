...
var _require2 = __webpack_require__(40),
    SITEINFO_BUILDIN = _require2.SITEINFO_BUILDIN,
    SITEINFO_TP = _require2.SITEINFO_TP,
    SITEINFO_comp = _require2.SITEINFO_comp;
...
(function () {
  ...
  Promise.all([GM.getValue("prefs", JSON.stringify(prefsFactory)), GM.getValue("SITEINFO_D", JSON.stringify(SITEINFO_D)), GM.getValue("autoMatch", JSON.stringify(autoMatch)), GM.getValue("jsonRuleInfo", JSON.stringify(jsonRule.info)), GM.getValue("SITEINFO_json", JSON.stringify(jsonRule.rule)), GM.getValue("version", "1.0.00")]).then(function (values) {
    ...
    var SP = {
      ...
      loadSetting: function loadSetting() {
        ...
        var loadCustomSiteInfo = function loadCustomSiteInfo() {
          ...
          if (_.isArray(infos)) {
            SITEINFO = infos.concat(SITEINFO_BUILDIN);
          }
        };
    ...
    function init(window, document) {
      ...
      SITEINFO = SITEINFO_BUILDIN.concat(SITEINFO_json, SITEINFO_TP, SITEINFO_comp);
...
var pkg = __webpack_require__(39); //  ///////// ----- Rules for specific sites -------///////////
//  Highest priority


var SITEINFO_BUILDIN = [// todo: get and new var in main
{
  // 站点名字...(可选)             // 站点正则...(~~必须~~)
  name: "Google搜索",
...
module.exports = {
  SITEINFO_BUILDIN,
  SITEINFO_TP,
  SITEINFO_comp //SITEINFO_json, // todo: appropriate?
